...
const useCountUp = (end: number | string, duration = 2000, inView = false) => {
  const numericEnd =
    typeof end === 'string' ? Number.parseInt(end.replace(/\D/g, ''), 10) : end;
          ...
          {highlights.map((item, index) => (
            ...
            >
              <p className="mb-1 text-3xl font-bold text-foreground">
                {index < 3
                  ? getAnimatedMetric(item.metric, index)
                  : item.metric}
              </p>
    ...
    <main>
      ...
      <section className="py-16 md:py-24">
        <div className="mx-auto max-w-4xl px-6">
          ...
          <p className="mb-8 text-muted-foreground">
            I&apos;ve worked across the fintech and AI landscape, from regulated
            financial services to cutting-edge AI startups.
          </p>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="rounded-2xl border border-border/60 bg-card p-6">
              ...
              <p className="mb-4 text-sm text-muted-foreground">
                Building financial products that move money, assess risk, and
            ...
            <div className="rounded-2xl border border-border/60 bg-card p-6">
              ...
              <p className="mb-4 text-sm text-muted-foreground">
                Shipping AI-powered features and products, from LLM integrations
            ...
            <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
              <div className="flex-1">
                ...
                <p className="mb-4 text-muted-foreground">
                  I&apos;m actively looking to relocate to{' '}
                  <span className="font-medium text-foreground">Dubai</span> or{' '}
                  <span className="font-medium text-foreground">Abu Dhabi</span>
                  . I visit twice a year and am serious about making it my
                  permanent home. The UAE&apos;s booming fintech scene and AI
                  investment make it the perfect next step for my career.
                </p>
                <p className="mb-4 text-sm text-muted-foreground">
                  Interested in roles at companies like{' '}
                  <span className="text-foreground">Noon</span>,{' '}
                  <span className="text-foreground">Careem</span>,{' '}
                  <span className="text-foreground">Property Finder</span>,{' '}
                  <span className="text-foreground">Wio</span>, or sovereign
                  wealth funds like{' '}
      ...
      <section className="border-t border-border py-16 md:py-24">
        <div className="mx-auto max-w-4xl px-6 text-center">
          ...
          <p className="mb-8 text-muted-foreground">
            I&apos;d love to hear about your opportunity. Let&apos;s chat about
