...
const socialLinks = [
  ...
  { icon: "fa-instagram", url: "https://instagram.com/yourusername", label: "Instagram" },
  { icon: "fa-youtube", url: "https://youtube.com/@yourusername", label: "YouTube" },
  { icon: "fa-tiktok", url: "https://tiktok.com/@yourusername", label: "TikTok" },
        ...
        >
          ...
          <div className="flex items-center justify-center gap-4">
            {socialLinks.map((social) => (
              ...
              >
                <i className={`fa-brands ${social.icon} text-sm`} aria-hidden="true" />
              </a>
            ))}
          </div>
        </motion.div>
