...
const blogPosts: BlogPost[] = [
  {
    ...
    excerpt: "The complete story of building a kids colouring app as a solo developer, from idea to App Store.",
    category: "Case Study",
    readTime: "8 min read",
    date: "Jan 10, 2026",
  ...
  },
  {
    ...
    excerpt: "Why I chose React Native, Expo, TypeScript, and Postgres for my indie projects.",
    category: "Dev Log",
    readTime: "5 min read",
    date: "Jan 5, 2026",
  ...
  },
  {
    ...
    excerpt: "Lessons learned from building an audience while shipping products as an indie hacker.",
      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        >
          <div className="space-y-2">
            <h2 className="text-3xl font-bold tracking-tight text-foreground md:text-4xl">From the Blog</h2>
            <p className="text-muted-foreground">Thoughts on building products, coding, and the creator life.</p>
          </div>
              ...
              >
                ...
                >
                  <div className="mb-4 flex items-center gap-3">
                    ...
                    >
                      <i className={`fa-solid ${categoryIcons[post.category] || "fa-file-alt"} text-muted-foreground`} aria-hidden="true" />
                      {post.category}
                    </motion.span>
                  ...
                  <p className="mb-4 flex-grow text-sm text-muted-foreground">{post.excerpt}</p>
                  ...
                  >
                    ...
                    >
                      Read more <i className="fa-solid fa-arrow-right ml-1" aria-hidden="true" />
                    </motion.span>
                  </motion.div>
                </motion.div>
              </Link>
