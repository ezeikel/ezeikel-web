...
const projects: Project[] = [
  {
    ...
    description:
      'Digital colouring designed for little hands. Large tools, curated illustrations, and zero ads.',
  ...
  },
  {
    ...
    description:
      'Track, manage, and appeal UK parking tickets with AI-powered letter generation.',
  ...
  },
  {
    ...
    description:
      'A developer journal that lives where you work. Log, track streaks, and export for standups.',
  ...
  },
  {
    ...
    description:
      'Combining AI and developer productivity. Subscribe to get updates when it launches.',
      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        >
          ...
          <p className="max-w-xl text-lg text-muted-foreground">
            A collection of apps, tools, and experiments I&apos;m always tending
            to.
          </p>
        </motion.div>
