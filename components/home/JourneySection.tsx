...
const milestones: Milestone[] = [
  {
    ...
    description: "Discovered my passion for building things with code. First lines of JavaScript.",
    icon: "fa-code",
  },
  {
    year: "2017",
  ...
  },
  {
    ...
    description: "Promoted to Senior Software Engineer. Leading projects and mentoring juniors.",
    icon: "fa-arrow-up",
    highlight: true,
  },
  {
  ...
  },
  {
    ...
    description: "Shipped my first indie app. A colouring app designed for kids.",
    icon: "fa-rocket",
    highlight: true,
  },
  {
  ...
  },
  {
    ...
    description: "Launched my second app. Helping people fight unfair parking tickets.",
    icon: "fa-car",
    highlight: true,
  },
]
      ...
      <div className="sticky top-0 flex h-screen flex-col overflow-hidden bg-secondary/30">
        ...
        <div className="shrink-0 px-6 pt-16 pb-6">
          <div className="mx-auto max-w-6xl">
            <p className="mb-2 text-sm font-medium text-primary">The Timeline</p>
                ...
                >
                  ...
                  <div
                    className={`mb-4 flex h-12 w-12 items-center justify-center rounded-xl ${
                      milestone.highlight ? "bg-primary text-primary-foreground" : "bg-secondary text-foreground"
                    }`}
                  >
                    <i className={`fa-solid ${milestone.icon} text-lg`} aria-hidden="true" />
                  </div>
        ...
        >
          <p className="mb-2 text-xs text-muted-foreground">Scroll to explore</p>
          <i className="fa-solid fa-chevron-down text-muted-foreground" aria-hidden="true" />
        </motion.div>
      </div>
    </div>
  )
