...
const contentItems: ContentItem[] = [
  {
    ...
    views: "24K",
    href: "#",
    description: "Complete walkthrough of setting up and building your first React Native app with Expo.",
  },
  {
    id: "2",
  ...
  },
  {
    ...
    views: "89K",
    href: "#",
    description: "The full story behind building and launching my kids colouring app.",
  },
  {
    id: "4",
    ...
    views: "18K",
    href: "#",
    description: "From idea to App Store - building a ticket management app with AI.",
  },
  {
    id: "5",
...
const LatestContentSection = () => {
  ...
  const getVisibleVideos = () => {
    const videos = []
    for (let i = -2; i <= 2; i++) {
      const index = (activeIndex + i + contentItems.length) % contentItems.length
  ...
  return (
    <section ref={sectionRef} className="relative overflow-hidden py-16 md:py-24">
      <motion.div style={{ opacity }} className="mx-auto max-w-6xl px-6">
        ...
        >
          <h2 className="mb-3 text-3xl font-bold tracking-tight text-foreground md:text-4xl">Long Form</h2>
          ...
          <div className="relative flex h-[320px] md:h-[380px] items-center justify-center px-16">
            <AnimatePresence mode="popLayout">
              {getVisibleVideos().map((video) => {
                ...
                const xOffset = video.position * (isCenter ? 0 : 280 + absPosition * 40)
                const scale = isCenter ? 1 : Math.max(0.75 - absPosition * 0.1, 0.55)
                const zIndex = 10 - absPosition
                const itemOpacity = isCenter ? 1 : Math.max(0.6 - absPosition * 0.2, 0.3)
                ...
                return (
                  <motion.div
                    ...
                    onClick={() => !isCenter && setActiveIndex(contentItems.findIndex((v) => v.id === video.id))}
                  ...
                  >
                    ...
                    >
                      <div className={`relative overflow-hidden ${isCenter ? "aspect-video" : "aspect-video"}`}>
                        <img
        ...
        >
          <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
            <Button asChild variant="outline">
              <Link href="https://youtube.com/@yourusername" target="_blank" rel="noopener noreferrer">
                <i className="fa-brands fa-youtube mr-2 text-red-500" aria-hidden="true" />
