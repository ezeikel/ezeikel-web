...
const featuredProducts = [
  {
    ...
    description: "Production-ready boilerplate with auth, payments, and push notifications. Ship your app faster.",
    price: "$99",
    tag: "Coming Soon",
  ...
  },
  {
    ...
    description: "Step-by-step guide from idea to App Store. Learn from real launches.",
    price: "$29",
    tag: "PDF Guide",
    icon: "fa-book",
    featured: false,
            ...
            {featuredProducts.map((product) => (
              ...
              >
                <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-xl bg-secondary">
                  <i className={`fa-solid ${product.icon} text-xl text-foreground`} aria-hidden="true" />
                </div>
          ...
          <div className="rounded-2xl border border-border/60 bg-card p-6">
            <div className="mb-4 flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-secondary">
                <i className="fa-solid fa-heart text-foreground" aria-hidden="true" />
              </div>
              <div>
              ...
              {tipOptions.map((tip) => (
                ...
                >
                  <span className="flex items-center gap-2">
                    <i className={`fa-solid ${tip.icon} text-muted-foreground`} aria-hidden="true" />
                    <span className="text-foreground">{tip.label}</span>
                  </span>
                  <span className="font-medium text-foreground">{tip.amount}</span>
                </button>
              ))}
            </div>
