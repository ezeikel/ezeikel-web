...
export const contentSeries: ContentSeries[] = [
  {
    ...
    description:
      'Full dev log series documenting the creation of Parking Ticket Pal from idea to launch.',
  ...
  },
  {
    ...
    description:
      'Behind the scenes of building a kids colouring app with React Native and Expo.',
...
export const contentItems: ContentItem[] = [
  {
    ...
    description:
      'Starting a new indie app project. Watch as I set up the development environment and plan features.',
    platform: 'YouTube',
  ...
  },
  {
    ...
    description:
      'A typical day building apps, creating content, and managing the business side of indie hacking.',
    platform: 'TikTok',
  ...
  },
  {
    ...
    description:
      'Full tour of my home office setup, gear, and the tools I use daily for coding and content creation.',
    platform: 'Instagram',
  ...
  },
  {
    ...
    description:
      'Quick comparison of the two most popular cross-platform frameworks.',
    platform: 'Shorts',
  ...
  },
  {
    ...
    description:
      'Integrating OpenAI into Parking Ticket Pal to generate appeal letters.',
    platform: 'YouTube',
  ...
  },
  {
    ...
    description:
      'Real numbers and honest talk about making money as an indie developer.',
    platform: 'TikTok',
...
export const getFeaturedContent = (): ContentItem[] =>
  contentItems.filter((item) => item.featured);
