...
export const projects: Project[] = [
  {
    ...
    links: {
      ...
      playStore: "https://play.google.com/store/apps/details?id=com.chunkycrayon",
    },
    metrics: [
    ...
    screenshots: ["/chunky-crayon-screenshot-1.jpg", "/chunky-crayon-screenshot-2.jpg"],
    problem:
  ...
  },
  {
    ...
    techStack: ["React Native", "Expo", "TypeScript", "Postgres", "Stripe", "AI"],
    status: "Live",
    category: "Consumer Apps",
    features: [
    ...
    links: {
      ...
      playStore: "https://play.google.com/store/apps/details?id=com.parkingticketpal",
    },
    metrics: [
    ...
    screenshots: ["/parking-ticket-pal-screenshot-1.jpg", "/parking-ticket-pal-screenshot-2.jpg"],
    problem:
